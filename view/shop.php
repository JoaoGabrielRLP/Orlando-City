	...
	<div class="container" id="destaque-produtos-container" ng-controller="destaque-controller">
		...
		<div id="destaque-produtos">
			...
			<div class="item">
				...
				<div class="col-sm-6 col-imagem">
					<img src="img/produtos/{{foto_principal}}" alt="{{nome_prod_longo}}">
				</div>
				<div class="col-sm-6 col-descricao">
					...
					<div class="box-valor">
						...
						<div class="text-por text-arial-cinza">por</div>
						<div class="text-reais text-roxo">R$</div>
						<div class="text-valor text-roxo">{{preco}}</div>
						<div class="text-valor-centavos text-roxo">,{{centavos}}</div>
						<div class="text-parcelas text-arial-cinza">ou em até {{parcelas}}x de R$ {{parcela}}</div>
						<div class="text-total text-arial-cinza">total a prazo R$ {{total}}</div>	
					</div>
					<a href="#" class="btn btn-comprar text-roxo"><i class="fa fa-shopping-cart"></i> compre agora</a>
				</div>
...
<script>
	angular.module("shop", []).controller("destaque-controller", function($scope){
		...
		$scope.produtos.push({
			nome: "Smartphone Motorola Moto X Play Dual Chip Desbloqueado Andoid 5.1",
