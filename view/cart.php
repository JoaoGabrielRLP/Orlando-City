...
<section  ng-controller="cart-controller">
	...
	<div class="container">
		...
		<div ng-if="mensagemCompra" class="alert alert-success" style="margin-top:10px">
			{{mensagemCompra}}
		</div>

		<button type="button" class="btn btn-roxo pull-right" style="margin-top:10px" ng-click="comprar()" ng-disabled="produtos.length === 0">comprar</button>
...
angular.module("shop", []).controller("cart-controller", function($scope, $http){
	...
	$scope.comprar = function(){
		...
		$http({
			...
			console.error(response);
			$scope.mensagemCompra = 'Não foi possível finalizar a compra. Tente novamente.';
